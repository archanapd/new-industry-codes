        ...
        <div className='tab-panel-wrapper py-5'>
          ...
          <div className="row mt-5">
            <div className="col-md-4 d-flex mb-5">
              <span><SettingsOutlinedIcon className='code-ico-color-red' /></span>
              <div className='code-ico-desc ps-2'><small>Industry Sector</small> Retail Trade</div>
            </div>
            <div className="col-md-4 d-flex mb-5">
              <span><BusinessOutlinedIcon className='code-ico-color-red' /></span>
              <div className='code-ico-desc ps-2'><small>Total Companies</small>  28,606</div>
            </div>
            <div className="col-md-4 d-flex mb-5">
              <span><BusinessOutlinedIcon className='code-ico-color-red' /></span>
              <div className='code-ico-desc ps-2'><small>Verified Companies</small>  28,606</div>
            </div>
            <div className="col-md-4 d-flex mb-5">
              <span><WorkOutlineOutlinedIcon className='code-ico-color-red' /></span>
              <div className='code-ico-desc ps-2'><small>Est. Employment</small>  28,606</div>
            </div>
            <div className="col-md-4 d-flex mb-5">
              <span><MonetizationOnOutlinedIcon className='code-ico-color-red' /></span>
              <div className='code-ico-desc ps-2'><small>Annual Payroll </small>   $62,740,453,000</div>
            </div>
            <div className="col-md-4 d-flex mb-5">
              <span><MonetizationOnOutlinedIcon className='code-ico-color-red' /></span>
              <div className='code-ico-desc ps-2'><small>Total Revenu</small>  $908,952,627,000</div>
            </div>
          </div>
          ...
          <ul className="row classification-bar pb-4">
            <li className="col-md-6 d-flex flex-column mb-4 mb-md-0">
              ...
              <div className='color-bar d-flex bg-light-green mt-2'><span className='bar-nom'>4411</span> Automobile Dealers</div>
            </li>
            <li className="col-md-6 d-flex flex-column ">
              <small className='txt-small'>Subcategories</small>
              <div className='color-bar d-flex bg-light-yellow mt-2'><span className='bar-nom'>44111</span> New Car Dealers</div>
