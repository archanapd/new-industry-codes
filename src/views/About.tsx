              ...
              <li className='col-sm-6 col-lg-3 mb-4'>
                <div className="card">
                  ...
                  <div className="card-body p-5">
                    ...
                    <p className="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas pulvinar scelerisque metus, a porttitor nisl dapibus ac. Suspendisse vitae mi massa</p>
                  </div>
                </div>
              </li>
              <li className='col-sm-6 col-lg-3 mb-4'>
