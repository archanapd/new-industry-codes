      ...
      <Box sx={{ bgcolor: '#fff', paddingTop: '94px' }}>
        ...
        <main className="pb-5">
          ...
          <section className="container code-mapping-block py-5">
            <h2 className="block-title text-center pt-md-5 pb-md-5 mb-5">
              NAICS to SIC Code Mapping for{' '}
              <span className="txt-red">"0711"</span>
            </h2>
            <ul className="row">
              <li className="col-lg-6 mb-4">
                <h6 className="txt-black-light-color mb-3">SIC CODE</h6>
                <span className="color-bar green-bar p-4">
                  <span>0711</span> Soil Preparation Services
                </span>
              </li>
              <li className="col-lg-6 mb-4">
                <h6 className="txt-black-light-color mb-3">NAICS CODE</h6>
                <span className="color-bar yellow-bar p-4">
                  <span>115112</span> Soil Preparation, Planting, and
                  Cultivating
                </span>
              </li>
            </ul>
