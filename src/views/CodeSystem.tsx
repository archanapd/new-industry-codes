            ...
            <div className="container px-4 py-5">
              ...
              <div className="row">
                <div className="col-md-9">
                  <h2 className="block-title pt-md-5 pb-md-4">Lorem ipsum dolor title</h2>
                  ...
                  <p> Aliquam ac neque nisl. Cras nec elit in mauris semper mollis. Nam ultricies lectus sit amet nulla convallis, sit amet condimentum augue dignissim. Sed sit amet nisl tempus, congue diam at, dictum nisl. Maecenas maximus turpis at mauris imperdiet</p>
                </div>
              </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-8">
                  <h2 className='block-title mb-4'>Conversions / Cross-References</h2>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas pulvinar scelerisque metus, a porttitor nisl dapibus ac. Suspendisse vitae mi massa.</p>
                </div>
              </div>
              <div className="row mb-5">
                <div className="col-md-9">
                  <ul className='d-flex'>
                    <li className="col-6 pe-4"><SelectDropDown /></li>
                    <li className="col-6"><SelectDropDown /></li>
                  </ul>
                </div>
              </div>
                ...
                <div className="col-md-10">
                  <ul className="row">
                    <li className="col-md-6 pe-md-5">
                      <h2 className='block-title mb-4'>What is the SBA NAICS 111992 revenue limit?</h2>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas pulvinar scelerisque metus, a porttitor nisl dapibus ac. Suspendisse vitae mi massa</p>
