  ...
  return (
    <div className="App inner-pages">
      ...
      <Box sx={{ bgcolor: '#fff', paddingTop: '94px' }}>
        ...
        <main className=''>
          <section className='why-sic-timeline'>
